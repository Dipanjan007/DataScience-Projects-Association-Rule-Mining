...
Plotting the item frequency for top 20 items

``` {r}
itemFrequencyPlot(x = Groceries, topN = 20)
...
for e.g. : If someone buys yoghart and cereals, they are 81% likely to buy Whole milk too.
...
plot(sorted_rules, method = "graph", shading = NA, interactive = T)
